...
# 
# This is ML project done in COMP9417 where I practise the standard ML pipeline skill based on various sources mostly Kaggle.  Numerical Dataset is supplied.
